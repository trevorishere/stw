...
const PRODUCTS = [
  {
    ...
    title: <>The Quantum Empowerment Black Card<sup className="font-normal text-[32px] max-tablet:text-[24px] max-phone:text-[15px]">©TM©</sup></>,
  ...
  },
  {
    ...
    title: <>The STW Tarot<sup className="font-normal text-[32px] max-tablet:text-[24px] max-phone:text-[15px]">©TM©</sup></>,
