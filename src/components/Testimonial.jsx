      ...
      <div className="page-container px-24 max-tablet:px-16 pb-28
        ...
        <div className="bg-dark py-[136px] flex flex-col gap-6">
          ...
          <div className="mx-auto max-w-[66%] max-phone:max-w-[80%] w-full flex flex-col gap-6">
            ...
            <blockquote className="reveal-heading blockquote-hanging font-bitter font-light text-[32px] leading-[48px] tracking-[0.005em] text-accent
            ...
            <div className="reveal-body flex flex-col ml-4">
              <p className="font-figtree font-bold text-[16px] leading-7 tracking-[0.3px] text-cream
                            max-phone:text-[14px] max-phone:leading-[22px]">
                Steve B.
              </p>
              <p className="font-figtree font-medium text-[14px] leading-[22px] tracking-[1px] text-cream
